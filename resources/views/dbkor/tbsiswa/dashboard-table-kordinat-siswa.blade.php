        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="col-sm-11 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex ">
              <button type="button" class="btn btn-primary  "><a href="/add_siswa" class="text-light">ADD</a></button>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;">{{$item ->nipd}}</td>
                      ...
                      <form action="{{ route('delete-siswa',$item->id)}}" method="post">
                        @csrf
                        @method('DELETE')
